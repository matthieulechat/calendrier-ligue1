...
| [BDR-015](decisions/BDR-015.md) | 2026-07-19 | Identité visuelle app retenue : AC1 "Carton Officiel"                        | #identite-visuelle #ac1 #logo #moodboard #palette #typography #design-system #ligue1    | actif  |
| [BDR-016](decisions/BDR-016.md) | 2026-07-19 | Scope AC1 : chrome app uniquement, affiche garde couleurs club + typo seule  | #identite-visuelle #poster #theming #shadcn #typography #scope #ligue1 #architecture    | actif  |
| [BDR-017](decisions/BDR-017.md) | 2026-07-19 | Lisibilité logo : flag `logoNeedsBackdrop`, pas de traitement universel      | #logos #contrast #data-model #club-colors #yagni #marseille #poster                     | actif  |
| [BDR-018](decisions/BDR-018.md) | 2026-07-19 | Bouton d'installation PWA : réutilisation du hook `useInstallPrompt` ifecho  | #pwa #install-prompt #ifecho #fab #app-logo #reuse                                      | actif  |
| [BDR-019](decisions/BDR-019.md) | 2026-07-19 | ClubSwitcher `<1024px` : masquage CSS + valeurs forcées via `useMediaQuery`  | #responsive #media-query #clubswitcher #breakpoint #tailwind #forced-state #ux          | actif  |
