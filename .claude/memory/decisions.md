...
| [BDR-004](decisions/BDR-004.md) | 2026-07-02 | API-Football retenue comme source de données (Phase 6)                       | #api-football #api #phase2 #phase6 #spike #ligue1 #pipeline #donnees                 | actif  |
