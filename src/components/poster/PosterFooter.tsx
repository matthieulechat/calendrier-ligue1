...
export const PosterFooter = ({ club, updatedAt }: PosterFooterProps) => (
  <footer className="mt-[2mm] pt-[1.5mm] border-t-[0.3mm] border-white/[22%] flex items-center justify-between gap-[3mm] break-inside-avoid">
    <div className="text-[6.5pt] text-white/40 leading-[1.5] flex-1">
      ...
      <span className="block mt-[1mm] text-white/30">
        Calendrier mis à jour le {updatedAt} · Application non officielle,
